        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-background/60">
              <li><Link href="/landing" className="hover:text-background">Tính tỉ lệ đỗ</Link></li>
              <li><Link href="/unimap" className="hover:text-background">UniMap — Trường ĐH</Link></li>
              <li><Link href="/majorly" className="hover:text-background">Majorly — Ngành học</Link></li>
